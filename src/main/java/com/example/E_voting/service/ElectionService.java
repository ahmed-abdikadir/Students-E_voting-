...
public interface ElectionService {
    ...
    // Added for student dashboard progress tracking
    List<com.example.E_voting.model.Vote> getVotesByStudentId(String studentId);
    ...
    CandidateApplication applyForCandidate(String username, Long electionId, String motive);

    List<CandidateApplication> getPendingApplications();

    List<CandidateApplication> getApplicationsByUsername(String username);

    CandidateApplication approveApplication(Long applicationId);
